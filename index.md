...
Shared expenses and payment records,
Household chores and task lists,
Notes optionally added by the user,
Photos optionally added by the user,
Adding photos is completely optional. Users are not required to upload or attach photos.
...
Track weekly household tasks,
Manage user accounts and sessions,
Keep the app secure, stable, and functional,
User data is not sold, rented, or shared with third parties for advertising purposes.
...
6. Data Security
We take reasonable technical and administrative measures to protect user information. However, no method of internet transmission or digital storage is completely risk-free.

7. Children’s Privacy
Ev Hesabı is not designed for children under the age of 13. We do not knowingly collect personal information from children under 13.

8. User Rights
Users may view, edit, or delete their data within the app. For privacy-related or data deletion requests, users may contact us.

9. Changes to This Policy
This Privacy Policy may be updated from time to time. Updates become effective when published on this page.

10. Contact
For questions about this Privacy Policy, you can contact us at:

Email: studioskozen@gmail.com
...
Kullanıcı kimliği,
Ev grubu bilgileri,
Ortak giderler ve ödeme kayıtları,
Ev işleri ve görev listeleri,
Kullanıcı tarafından isteğe bağlı olarak eklenen notlar,
Kullanıcı tarafından isteğe bağlı olarak eklenen fotoğraflar,
Fotoğraf ekleme özelliği tamamen isteğe bağlıdır. Kullanıcılar fotoğraf eklemek zorunda değildir.
...
Haftalık ev görevlerini takip etmek,
Kullanıcı hesabını ve oturumunu yönetmek,
Uygulamanın güvenli, düzenli ve hatasız çalışmasını sağlamak,
Kullanıcı verileri satılmaz, kiralanmaz veya üçüncü taraflarla reklam amacıyla paylaşılmaz.
...
6. Veri Güvenliği
Kullanıcı bilgilerinin güvenliğini sağlamak için makul teknik ve idari önlemler alınır. Ancak internet üzerinden veri aktarımı veya dijital depolama yöntemlerinin tamamen risksiz olduğu garanti edilemez.

7. Çocukların Gizliliği
Ev Hesabı, 13 yaş altındaki çocuklara yönelik olarak tasarlanmamıştır. Bilerek 13 yaş altındaki çocuklardan kişisel veri toplamayız.

8. Kullanıcı Hakları
Kullanıcılar, uygulama içindeki verilerini görüntüleyebilir, düzenleyebilir veya silebilir. Gizlilik ve veri silme talepleri için bizimle iletişime geçebilirler.

9. Değişiklikler
Bu Gizlilik Politikası zaman zaman güncellenebilir. Güncellemeler bu sayfada yayımlandığı anda geçerli olur.

10. İletişim
Gizlilik Politikası ile ilgili sorularınız için bizimle iletişime geçebilirsiniz:

E-posta: studioskozen@gmail.com
